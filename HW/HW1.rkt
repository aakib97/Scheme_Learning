...
(define (malth t p a) (* p (expt 2 (* a t))))

(define (num Pi Ps) (* Ps Pi))
(define (denom Pi Ps alpha t) (+ Pi (*(- Ps Pi) (expt 2.718 (* -1 (* alpha t))))))
(define (singlespecies Pi Ps alpha t) (/(num Pi Ps) (denom Pi Ps alpha t)))